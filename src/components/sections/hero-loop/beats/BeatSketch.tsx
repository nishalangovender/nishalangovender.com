...
import { progressInWindow } from "@/lib/progress";
    ...
    >
      ...
      <g transform="translate(84.4 147.6) scale(0.82)">
        ...
        <StrokePath
          ...
          progress={progressInWindow(p, 0.0, 0.1)}
          vectorEffect="non-scaling-stroke"
        />
        {/* World frame — X axis */}
        <StrokePath
          d="M 80 320 L 520 320 M 512 316 L 520 320 L 512 324"
          progress={progressInWindow(p, 0.11, 0.2)}
          vectorEffect="non-scaling-stroke"
        />
        ...
        <path
          ...
          strokeLinecap="round"
          strokeDasharray="5 6"
          strokeDashoffset={260 * (1 - progressInWindow(p, 0.5, 0.62))}
          fill="none"
          opacity={progressInWindow(p, 0.5, 0.62)}
          vectorEffect="non-scaling-stroke"
        />
        ...
        <StrokePath
          ...
          progress={progressInWindow(p, 0.63, 0.7)}
          vectorEffect="non-scaling-stroke"
        />
        ...
        <StrokePath
          ...
          progress={progressInWindow(p, 0.71, 0.77)}
          vectorEffect="non-scaling-stroke"
        />
        {/* Body frame — y axis */}
        <StrokePath
          d="M 300 218 L 262.0 136.4 M 269.0 142.0 L 262.0 136.4 L 261.7 145.4"
          progress={progressInWindow(p, 0.78, 0.83)}
          vectorEffect="non-scaling-stroke"
        />
        ...
        <StrokePath
          ...
          progress={progressInWindow(p, 0.84, 0.89)}
          stroke="var(--accent)"
          vectorEffect="non-scaling-stroke"
        />
        ...
        <StrokePath
          ...
          progress={progressInWindow(p, 0.9, 0.95)}
          stroke="var(--accent)"
          vectorEffect="non-scaling-stroke"
        />

        {/* Labels */}
        <Typewriter text="Y" progress={progressInWindow(p, 0.96, 0.98)} x={68}  y={117} />
        <Typewriter text="X" progress={progressInWindow(p, 0.96, 0.98)} x={526} y={324} />
        <Typewriter text="θ" progress={progressInWindow(p, 0.97, 0.99)} x={140} y={312} />
        <Typewriter text="x" progress={progressInWindow(p, 0.97, 0.99)} x={415} y={183} />
        <Typewriter text="y" progress={progressInWindow(p, 0.97, 0.99)} x={252} y={132} />
        <Typewriter text="V" progress={progressInWindow(p, 0.98, 1.0)} x={452} y={148} />
        <Typewriter text="ω" progress={progressInWindow(p, 0.98, 1.0)} x={180} y={185} />
      </g>
    </svg>
  );
}
