...
export const zones: { key: ZoneKey; data: ZoneData }[] = [
  {
    ...
    data: {
      ...
      skills: [
        ...
        { name: "LLMs / Claude", icon: SiAnthropic, proficiency: 80, color: "#D97757" },
        { name: "Agent Design (Skills, Hooks, MCP)", icon: TbTopologyStar3, proficiency: 78 },
        { name: "Prompt Engineering", icon: TbPrompt, proficiency: 78 },
        { name: "Next.js", icon: SiNextdotjs, proficiency: 75 },
        { name: "TypeScript", icon: SiTypescript, proficiency: 75, color: "#3178C6" },
        { name: "Agent Memory & Evals", icon: TbDatabaseSearch, proficiency: 70 },
